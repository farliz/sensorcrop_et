...
\setlayer[bground]{\externalfigure[img/bg1]}
\blackrule[height=2pt, color=mgreen, width=\textwidth]
\blank[big]
\bTABLE
\bTR\bTD[width=14cm] \externalfigure[img/sc][width=7cm]\eTD \bTD {\bf Equipo Técnico}  \eTD\eTR
\bTR\bTD \externalfigure[img/yubox][width=6cm]\eTD \bTD  Gabriel Morejón\\Wendy Obregón\\Lizardo Reyna\\Joffre Moreira  \eTD\eTR
\eTABLE
%\blank[1cm]
...
\stopframedtext
\placefigure[][]{Evapotranspiracion}{\externalfigure[img/et][width=.9\textwidth]}
...
recuperarse}{\externalfigure [img/water][width=.9\textwidth]}
